...
int main(){
    ...
    system("pause");
    f=123.456;
    printf("Probando diferentes cantidades en cifras 7.0, 7.3 y 7.1\n");
    printf("%7.0f %7.3f %7.1f\n",f,f,f);/*123.456000 123.456 123.5 el utlimo se
    ...
    printf("Probando diferentes precisiones en cadenas: 10, 15 y 15.5\n");
    printf("%10s %15s %15.5s\n",letras,letras, letras,letras);
    system("pause");
    printf("Impresion con signo: $+d\n, i");
    printf("Impresion con espacios al principio y final del dato y con ceros\n");
    printf("%3d %5d %8d\n",i,i,i);
    printf("%-3d %-5d %-8d\n",i,i,i);
    printf("%03d %05d %08d\n",i,i,i);
    system("pause");
